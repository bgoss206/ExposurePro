...
function SideMenu() {
  ...
  return (
    <Sidebar>
      <Menu>
        <MenuItem component={<Link to="/Dashboard"/>}> {collapsed ? <GridViewIcon/>: "Dashboard"}</MenuItem>
        ...
        <MenuItem component={<Link to="/Settings"/>}> {collapsed ? <SettingsIcon/>: "Settings"}</MenuItem>
        <MenuItem component={<Link to="/"/>}> {collapsed ? <LogoutIcon/>: "Logout"} </MenuItem>
        <MenuItem onClick={() => {
            toggle();
          }}> {collapsed ? <KeyboardArrowRightIcon /> : <KeyboardArrowLeftIcon />} </MenuItem>
